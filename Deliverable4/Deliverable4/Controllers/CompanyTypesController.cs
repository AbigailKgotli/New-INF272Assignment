...
namespace Deliverable4.Controllers
{
    public class CompanyTypesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "CompanyTypeID,Description")] CompanyType companyType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "CompanyTypeID,Description")] CompanyType companyType)
        {
            if (ModelState.IsValid)
            {
